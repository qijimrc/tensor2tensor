...
"""
# 整个T2T运行过程中的单例。
# 存储着每一个模型的所有需要超参数hparams，以及每一个probem对应的参数
...
# 注册model，在trainer入口出通过引入models.__ini__处，已经进行了所有model的注册
...
# 注册problem，在data_generators下有所有的problem
