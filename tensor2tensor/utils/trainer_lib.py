...
# trainer 入口的辅助模块， 构建experement， estimator, input_fn,  params等的模块工具
...
def create_estimator(model_name,
                     ...
                     use_tpu=False):
  ipdb.set_trace()
  # 调用所有model的基类T2TModel, 根据指定的model名称生成一个estimator_fn(models
  # 中的一个model, 并且这个model的所有参数保存在registry单例中)
...
def create_experiment(run_config,
                      ...
                      use_tpu=False):
  ipdb.set_trace()
  # 生成tensorflow experiment对象， 包含model fn， input fn等
  """Create Experiment."""
  # HParams
